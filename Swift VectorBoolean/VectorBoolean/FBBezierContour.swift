...
public class FBBezierContour {
  ...
  public enum FBContourDirection
  {
    case clockwise
    case antiClockwise
  }
  ...
  public var reversedContour : FBBezierContour {
  ...
  public var direction : FBContourDirection {
  ...
  public var contourMadeClockwiseIfNecessary : FBBezierContour {
  ...
  public var intersectingContours : [FBBezierContour] {
  ...
  public var selfIntersectingContours : [FBBezierContour] {
  ...
  public func debugPathForIntersectionType(_ itersectionType: Int) -> UIBezierPath {
